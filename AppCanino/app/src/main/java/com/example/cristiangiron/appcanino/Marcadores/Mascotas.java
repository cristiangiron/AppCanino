...
public class Mascotas extends AppCompatActivity implements View.OnClickListener, Callback<SimpleResponse> {
    ...
    public void onResponse(Call<SimpleResponse> call, Response<SimpleResponse> response) {
        if(response.isSuccessful()){
            ...
            if(res.isSuccess()){
                Toast.makeText(Mascotas.this, "Reserva Guardada", Toast.LENGTH_SHORT).show();
                finish();
            }else{
                Toast.makeText(Mascotas.this, "Error Al Reservar", Toast.LENGTH_SHORT).show();
            }
