...
public class AnimalDoctor extends AppCompatActivity  implements View.OnClickListener, Callback<SimpleResponse> {
    ...
    public void onResponse(Call<SimpleResponse> call, Response<SimpleResponse> response) {
        if(response.isSuccessful()){
            ...
            if(res.isSuccess()){
                Toast.makeText(AnimalDoctor.this, "Reserva Guardada", Toast.LENGTH_SHORT).show();
                finish();
            }else{
                Toast.makeText(AnimalDoctor.this, "Error Al Reservar", Toast.LENGTH_SHORT).show();
            }
