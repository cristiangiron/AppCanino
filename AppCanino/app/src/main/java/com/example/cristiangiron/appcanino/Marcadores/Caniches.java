...
public class Caniches extends AppCompatActivity implements View.OnClickListener, Callback<SimpleResponse> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caniches);
    ...
    public void onResponse(Call<SimpleResponse> call, Response<SimpleResponse> response) {
        if(response.isSuccessful()){
            ...
            if(res.isSuccess()){
                Toast.makeText(Caniches.this, "Reserva Guardada", Toast.LENGTH_SHORT).show();
                finish();
            }else{
                Toast.makeText(Caniches.this, "Error Al Reservar", Toast.LENGTH_SHORT).show();
            }
