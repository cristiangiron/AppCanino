...
public class SalonCanino extends AppCompatActivity implements View.OnClickListener, Callback<SimpleResponse> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salon_canino);
    ...
    public void onResponse(Call<SimpleResponse> call, Response<SimpleResponse> response) {
        if(response.isSuccessful()){
            ...
            if(res.isSuccess()){
                Toast.makeText(SalonCanino.this, "Reserva Guardada", Toast.LENGTH_SHORT).show();
                finish();
            }else{
                Toast.makeText(SalonCanino.this, "Error Al Reservar", Toast.LENGTH_SHORT).show();
            }
